...
const PropertyEditForm = ({ property }: PropertyProps) => {
  ...
  return (
    <form
      action={(formData) => startTransition(() => clientAction(formData))}
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="mb-4">
          <label className="block  font-bold mb-2">Listing Name</label>
          <input
            type="text"
            id="name"
            name="name"
        ...
        <div className="flex flex-col space-y-4 sm:flex-row sm:space-y-0 sm:space-x-4">
          <div className="flex items-center">
            ...
            <input
              ...
              name="rates.weekly"
              className="border rounded w-full py-2 px-3"
              defaultValue={property.weeklyRate || ""}
            />
          </div>
          <div className="flex items-center">
            ...
            <input
              ...
              name="rates.monthly"
              className="border rounded w-full py-2 px-3"
              defaultValue={property.monthlyRate || ""}
            />
          </div>
          <div className="flex items-center">
      ...
      <div className="mb-4">
        <label htmlFor="seller_name" className="block  font-bold mb-2">
          Seller Name
        </label>
        <input
          type="text"
      ...
      <div className="mb-4">
        <label htmlFor="seller_email" className="block  font-bold mb-2">
          Seller Email
        </label>
        <input
          type="email"
      ...
      <div className="mb-4">
        <label htmlFor="seller_phone" className="block  font-bold mb-2">
          Seller Phone
        </label>
        <input
          type="tel"
